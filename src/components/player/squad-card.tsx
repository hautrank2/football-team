...
export const SquadCard = ({
  ...
  return (
    // The whole card tilts toward the pointer. The contents deliberately do NOT
    // ride at separate depths: translateZ magnifies a layer (perspective 1000px
    // makes 50px ≈ 5% bigger), so the portrait grew past the frame and exposed
    // the card border behind it. Tilting the card as one piece keeps it clipped.
    <TiltCard>
      <div
        className={cn(
